        ...
        <div class="clearfix"></div>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Subjects">
                            <div class="pull-left"><i class="fas fa-book-open"></i><span class="right-nav-text">{{trans('subjects_trans.The_subjects')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="Subjects" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('subjects.index')}}">{{trans('main_trans.Listofmaterials')}}</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                            ...
                            <li> <a href="{{route('questions.index')}}">{{trans('main_trans.quess_list')}}</a> </li>
                        </ul>
                    </li>
