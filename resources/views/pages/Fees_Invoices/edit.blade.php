...
@section('css')
    @toastr_css
@section('title')
    {{trans('fee_invoices_trans.edit_invoice')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                    ...
                    <form action="{{route('Fees_Invoices.update','test')}}" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputEmail4">{{trans('fee_invoices_trans.student_name')}}</label>
                            ...
                            <div class="form-group col">
                                <label for="inputEmail4">{{trans('fee_invoices_trans.amount')}}</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                <label for="inputZip">{{trans('fee_invoices_trans.fee_type')}}</label>
                        ...
                        <div class="form-group">
                            <label for="inputAddress">{{trans('fee_invoices_trans.notes')}}</label>
                            <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="4">{{$fee_invoices->description}}</textarea>
                        </div>
                        <br>

                        <button type="submit" class="btn btn-primary">{{trans('fee_invoices_trans.confirm')}}</button>
