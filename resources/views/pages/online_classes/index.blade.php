...
@section('css')
    @toastr_css
@section('title')
    {{trans('online_classes_trans.online_classes_list')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('online_classes.create')}}" class="btn btn-success" role="button" aria-pressed="true">{{trans('online_classes_trans.add_online_class')}}</a>
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr class="alert-success">
                                            ...
                                            <th>{{trans('online_classes_trans.classroom')}}</th>
                                            <th>{{trans('online_classes_trans.section')}}</th>
                                            <th>{{trans('online_classes_trans.teacher')}}</th>
                                            ...
                                            <th>{{trans('online_classes_trans.class_link')}}</th>
                                            <th>{{trans('online_classes_trans.actions')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
