...
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    {{trans('questions_trans.edit_question')}} :<span class="text-danger">{{$question->title}}</span>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('questions.update','test') }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <label for="title">{{trans('questions_trans.question_name')}}</label>
                                ...
                                <div class="form-row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="Grade_id">{{trans('questions_trans.quiz_name')}} : <span
                                                    class="text-danger">*</span></label>
                                            <select class="custom-select mr-sm-2" name="quizze_id">
                                                <option selected disabled>{{trans('questions_trans.choose_quiz')}}...</option>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="score">
                                                <option selected disabled> {{trans('questions_trans.choose_score')}}...</option>
                                ...
                                <br>
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('questions_trans.save')}}</button>
                            </form>
                        </div>
                    </div>
                </div>
