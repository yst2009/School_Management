                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{route('subjects.store')}}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        <label for="inputState">{{trans('subjects_trans.classroom')}}</label>
                                ...
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('subjects_trans.save')}}</button>
                            </form>
                        </div>
                    </div>
                </div>
