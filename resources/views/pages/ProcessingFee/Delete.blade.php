    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('processing_fee_trans.delete_fee')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('ProcessingFee.destroy','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('processing_fee_trans.delete_confirmation')}}</h5>
