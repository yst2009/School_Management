...
@section('css')
    @toastr_css
@section('title')
    {{trans('processing_fee_trans.processing_fees')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr class="alert-success">
                                            <th>#</th>
                                            <th>{{trans('processing_fee_trans.student_name')}}</th>
                                            <th>{{trans('processing_fee_trans.amount')}}</th>
                                            <th>{{trans('processing_fee_trans.description')}}</th>
