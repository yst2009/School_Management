...
@section('css')
    @toastr_css
@section('title')
  {{trans('receipt_trans.edit_receipt')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{trans('receipt_trans.edit_receipt')}} : <label style="color: red">{{$receipt_student->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                ...
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans('receipt_trans.amount')}} : <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans('receipt_trans.description')}} : <span class="text-danger">*</span></label>
                            ...
                            <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('receipt_trans.submit')}}</button>
                        </form>
