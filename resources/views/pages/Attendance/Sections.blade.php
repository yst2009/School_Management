...
@section('css')
    @toastr_css
@section('title')
    {{ trans('Sections_trans.title_page') }}: {{ trans('attendance_trans.title_page') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                                            ...
                                                            <table class="table center-aligned-table mb-0">
                                                                ...
                                                                @foreach ($Grade->Sections as $list_Sections)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <label class="badge badge-{{$list_Sections->Status == 1 ? 'success':'danger'}}">{{$list_Sections->Status == 1 ? trans('attendance_trans.active'):trans('attendance_trans.inactive')}}</label>
                                                                        </td>
