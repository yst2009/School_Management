    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('payment_trans.delete_payment')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('Payment_students.destroy','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('payment_trans.delete_confirmation')}}</h5>
